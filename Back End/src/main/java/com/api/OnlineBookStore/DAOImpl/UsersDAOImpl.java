...
public class UsersDAOImpl implements UsersDAO {
	...
	public Object createUser(Users input) throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("userCreate");
	...
	public Object getUsers() throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("getUsers");
	...
	public Object addAdmin(Admin param) throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("addAdmin");
	...
	public Object getAdmins() throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("getAdmins");
	...
	public Object updateAdmin(Boolean isDeleted, Integer adminId, Integer accessId) throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("updateAdmin");
	...
	public Object login(String email, String password, String type) throws Exception {
		...
		if (type.equals("user")) {
			jdbcCall = new SimpleJdbcCall(template)
					.withSchemaName("bookmybook").withProcedureName("loggedInUser");	
		} else {
			jdbcCall = new SimpleJdbcCall(template)
					.withSchemaName("bookmybook").withProcedureName("loggedInAdmin");
		}
	...
	public Object forgotPassword(String email) throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("userForgotPassword");
	...
	public Object updateAdminProfile(UpdateAdmin param) throws Exception {
		jdbcCall = new SimpleJdbcCall(template)
				.withSchemaName("bookmybook").withProcedureName("updateAdminProfile");
